...
public final class LevelManager
{
			...
			ArrayList<Enemy> math, ArrayList<Enemy> history)
	{
		...
		try {
			science.add(new Enemy(2, 2, 1, 200, 400, ImageIO.read(LevelManager.class.getResourceAsStream("/images/enemies/eclipsefront.png")),
		...
		try {
			english.add(new Enemy(2, 2, 1, 200, 400, ImageIO.read(LevelManager.class.getResourceAsStream("/images/enemies/eclipsefront.png")),
					new Dimension(100, 100), 2, true, false));
		}
		catch(IOException ioe)
		{
		...
		try {
			math.add(new Enemy(2, 2, 1, 200, 400, ImageIO.read(LevelManager.class.getResourceAsStream("/images/enemies/eclipsefront.png")),
					new Dimension(100, 100), 2, true, false));
		}
		catch(IOException ioe)
		{
		...
		try {
			history.add(new Enemy(2, 2, 1, 200, 400, ImageIO.read(LevelManager.class.getResourceAsStream("/images/enemies/eclipsefront.png")),
					new Dimension(100, 100), 2, true, false));
		}
		catch(IOException ioe)
		{

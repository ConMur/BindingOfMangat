...
/**
 * Rock patterns that are used by the rooms. They describe where the rocks in the rooms should go.
...
public class RockPattern {
    ...
    /**
     * Creates this rock pattern based on the provided pattern number
     * @param patternNum the pattern number to be used for this rock pattern
     */
    public RockPattern(int patternNum) {
        try {
    ...
    /**
     * Returns a list of each rock in this rock pattern
     * @return a list of each rock in this rock pattern
     */
    ...
    /**
     * Manually sets the positions of the rocks in this rock pattern based on the pattern number
     * @param newPattern the type of pattern to create
     */
     ...
     * @return the spawn locations for enemies
     */
